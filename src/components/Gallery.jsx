            ...
            <SwiperSlide key={index}>
              <div className="group">
                <img
                  src={image.src}
                  alt={image.alt}
                  className="w-full h-32 md:h-32 lg:h-64 object-cover rounded-2xl transform transition-transform duration-300 ease-in-out group-hover:scale-110 group-hover:brightness-110"
                />
              </div>
            </SwiperSlide>
          ))}
